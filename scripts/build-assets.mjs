...
const FLAGSHIP = {
  repo: 'VI-Translate',
  title: 'PDF Translate',
  blurb: `PDF translation into Vietnamese and 35 more languages ${DASH} layout, tables and formulas intact.`,
  chips: ['Windows', 'macOS', 'Android'],
  meta: `Python ${DOT} Kotlin ${DOT} AGPL-3.0`,
};
...
const HERO = {
  prompt: 'breslee1707 ~ $ whoami',
  name: 'Lê Ngọc Gia Huy',
  handle: 'HuyG',
  role: `AI Engineer @ Intel ${DOT} Robotics & AI ${DOT} Co-founder @ Code4life`,
  focus: `RAG ${DOT} Agents ${DOT} MCP ${DOT} Edge AI`,
};
...
const files = {
  ...
  'card-vi-translate-dark.svg': cardSVG(data, 'dark'),
  'card-vi-translate-light.svg': cardSVG(data, 'light'),
};
